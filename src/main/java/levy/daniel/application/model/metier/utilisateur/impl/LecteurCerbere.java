...
public class LecteurCerbere implements ILecteurCerbere {
	...
	public String toString() {
		...
		if (this.getCerbere() != null) {			
			builder.append(this.getCerbere());			
		} else {
			builder.append(NULL);
		}
		...
		if (this.getApplication() != null) {			
			builder.append(this.getApplication().getNom());
		} else {
			builder.append(NULL);
		}
		...
		if (this.getEntreprise() != null) {			
			builder.append(this.getEntreprise().getNom());
		} else {
			builder.append(NULL);
		}
		...
		if (this.getHabilitation() != null) {			
			builder.append(this.getHabilitation());
		} else {
			builder.append(NULL);
		}
		...
		if (this.getListeProfils() != null) {			
			builder.append(this.getListeProfils());
		} else {
			builder.append(NULL);
		}
		...
		if (this.getUtilisateur() != null) {			
			builder.append(this.getUtilisateur());
		} else {
			builder.append(NULL);
		}
