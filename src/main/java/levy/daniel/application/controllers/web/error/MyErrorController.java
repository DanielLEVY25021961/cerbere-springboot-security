 ...
 * Controller Web SPRING BOOT chargé d'aiguiller vers la bonne <strong>page
 * d'erreur erreurs.html, erreur-500.html...</strong> à chaque envoi du path
 * error "/error" par le conteneur de Servlets.<br/>
 * <br/>
 *
...
public class MyErrorController implements ErrorController {
	 ...
	 * <li>ajoute la Map des attributs d'erreurs provenant du DefaultErrorAttributes
	 * au org.springframework.ui.Model</li>
	 * <li><strong>retourne la page d'erreur en fonction du status de
	 * l'erreur.</strong></li>
	 * </ul>
	 *
	...
	public final String handleError(final HttpServletRequest pRequest, final DefaultErrorAttributes pErrorAttributes,
		...
		/*
		 * ajoute la Map des attributs d'erreurs provenant du DefaultErrorAttributes au
		...
		/* status de l'erreur. */
		final Object status = pRequest.getAttribute(RequestDispatcher.ERROR_STATUS_CODE);
