...
/**
 * CLASSE MonProfilTest :<br/>
 * Test JUnit de la classe {@link MonProfil}.<br/>
 * <br/>
 *
...
public class MonProfilTest {
	 ...
	 */
	private static final Log LOG = LogFactory.getLog(MonProfilTest.class);
	...
	*/
	...
	public void testToString() {
		...
		assertEquals("objetNull1.toString() retourne une chaine : "
				, "MonProfil [id=0, role=null, profil=null, portee=null, restriction=null]"
						, objetNull1.toString());
		...
		assertEquals("affichage : "
				, "MonProfil [id=1, role=ROLE_GESTIONNAIRE - DIRA, profil=GESTIONNAIRE, portee=DIRA, restriction=DIRA]"
						, objet1.toString());
...
} // FIN DE LA CLASSE MonProfilTest.-----------------------------------------
